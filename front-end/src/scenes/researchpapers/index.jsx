...
import { HandleSearchChangesRp } from "../../utilities/SearchHelper";
...
const
    ...
    const handleSearchTitle = (value) => {
        ...
        setSearchState({ ...searchState, title: value }); // Update searchState with the new value


        HandleSearchChangesRp(
            value,
            searchState,
            "title",
            filteredRows,
