...
ALTER TABLE `current_loan`
  ...
  ADD KEY `Fk_librarian_current_loan` (`email`),
...
ALTER TABLE `history`
  ADD PRIMARY KEY (`loan_id`),
  ADD KEY `Fk_librarian_history` (`email`),
...
ALTER TABLE `lost_items`
  ADD PRIMARY KEY (`copy_number`,`email`,`item_id`),
  ADD KEY `Fk_librarian_lost_items` (`email`);
...
ALTER TABLE `current_loan`
  ...
  ADD CONSTRAINT `Fk_librarian_current_loan` FOREIGN KEY (`email`) REFERENCES `librarian` (`email`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
ALTER TABLE `history`
  ...
  ADD CONSTRAINT `Fk_librarian_history` FOREIGN KEY (`email`) REFERENCES `librarian` (`email`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `lost_items`
  ADD CONSTRAINT `Fk_librarian_lost_items` FOREIGN KEY (`email`) REFERENCES `librarian` (`email`) ON DELETE NO ACTION ON UPDATE CASCADE;
